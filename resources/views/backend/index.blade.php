...
<head>
  ...
  <link rel="stylesheet" href="http://dental18.000webhostapp.com/public/assets/css/backend/style.css" type="text/css">
</head>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          {{-- <img src="{{ asset('storage/patientprofile/' .$patient->avatar) }}" class="img-circle elevation-2" alt="User Image"> --}}
          @yield('profile_image');
        </div>
        <div class="info">
          <a href="{{ route('p-profile') }}" class="d-block">{{ Auth::user()->name }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{ route('p-dashboard') }}" class="nav-link  
            @if(!$segment)
            active
            @endif
            ">
          ...
          <li class="nav-item">
            <a href="{{ route('p-appointment') }}" class="nav-link   
...
<script type="text/javascript">
  ...
  function comestoarraAlert ( formclass, type, link ) {
      ...
      swal({
          title: "Are you sure ?",
          text: "demo, are you sure want to continue ?",
          type: type,
      ...
      function ( isConfirm ) {
          if ( isConfirm ) {
              ...
              swal("Cancelled", "Action was cancelled by demo :)", "error");
          }
      });
