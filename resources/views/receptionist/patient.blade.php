...
<div class="container">
    <div class="col-md-12">
        <h4 style="font-size: 2.2rem">All Patient List <a href="{{ route('addpatients') }}" class="btn btn-primary float-right">Add New Patient</a></h4>  
      <br>
         ...
         <tbody>
             ...
             @foreach ($patients as $item)
                 <tr>
                    ...
                    <td><a href="#" class="btn btn-info">View</a><a href="#" class="btn btn-danger">Delete</a></td>
                 </tr>
             @endforeach
         </tbody>
      </table>
